...
static const char PROGMEM INDEX_HTML[] = R"rawliteral(
  ...
  <tr style="border:0px">
    ...
    <td colspan="2"><input type="button" id="getStill" value="Start Detection">
    <!--<input type="checkbox" id="showpix" value="Show Pixel" onclick="if (this.checked) canvas_custom.style.display='block'; else canvas_custom.style.display='none';">Show Pixel-->
    </td>
  </tr>
  <tr style="border:0px">
    <td style="text-align:center;background-color:red;"><a style="color:white;" onclick="changeTab('red');">Color 1 </a>
    <td style="text-align:center;background-color:green;"><a style="color:white" onclick="changeTab('green');">Color 2 </a></td>
    <td style="text-align:center;background-color:blue;"><a style="color:white" onclick="changeTab('blue');">Color 3 </a></td>
  </td>
  </tr><!---->
  <tr>
    <td colspan="3">
